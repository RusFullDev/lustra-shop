...
<template>
    <div class="flex justify-between py-[100px]">
<p class="text-grayn font-bold text-[40px] leading-[55px] w-[330px]">Производство светильников</p>
<div class="text-grayn font-medium text-xl w-[640px]">
